...
module.exports = function(app) {
	...
	*/
    ...
    app.get('/chord', function (req, res) {
        res.sendfile('./public/chord.html'); // load the single view file (angular will handle the page changes on the front-end)
    });
    app.get('/chordv3', function (req, res) {
        res.sendfile('./public/chord.v3.html'); // load the single view file (angular will handle the page changes on the front-end)
    });

    app.get('/wolves', function (req, res) {
        res.sendfile('./public/chord-wolves.html'); // load the single view file (angular will handle the page changes on the front-end)
    });
